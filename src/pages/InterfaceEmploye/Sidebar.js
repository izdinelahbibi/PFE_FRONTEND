...
import '../InterfaceEmploye/Sidebar.css';
  ...
  return (
    <div className="sidebar" ref={sidebarRef}>
      ...
      <ul className="nav-list">
        ...
        <li onClick={() => setActiveComponent('demandeachats')}>
          <button className="link-button">
            <i className="bx bx-cart"></i>
            <span className="link_name">Demandes d'achats</span>
          </button>
          <span className="tooltip">Demandes d'achats</span>
        </li>
        ...
        <li onClick={() => setActiveComponent('historiquedemande')}>
          <button className="link-button">
            <i className="bx bx-history"></i>
            <span className="link_name">Historique Demande</span>
          </button>
          <span className="tooltip">Historique Demande</span>
        </li>
